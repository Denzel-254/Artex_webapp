        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex items-center gap-4">
            ...
            <input
              ...
              placeholder="Email"
              className="p-3 border border-gray-300 outline-none bg-white w-full mb-4 rounded-md"
              required
            />{" "}
            <br />
          </div>
          ...
          <button
            type="submit"
            className="mt-4 p-3 w-full bg-orange-500 hover:bg-orange-700 cursor-pointer text-white rounded-md"
          >
            Log In
          </button>
        </form>
