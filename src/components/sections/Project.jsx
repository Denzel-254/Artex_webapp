        ...
        <section className="container mx-auto py-5">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="lg:mt-20">
                    <h3 className="text-3xl font-bold text-blue-950 md:text-4xl mb-10"> Unique Services</h3>
                ...
                <div>
                    <img src="/client2.png" alt="completed bulifing" className="w-full h-90 rounded-2xl" />
                    <h3 className="text-xl mt-3 font-bold text-gray-900 ">Free Consultation</h3>

                </div>

                <div>
                    <img src="/supervisor.png" alt="completed bulifing" className="w-full h-90 rounded-2xl" />
                    <h3 className="text-xl mt-3 font-bold text-gray-900">Project Management</h3>

                </div>

                <div>
                    <img src="/discussion.png" alt="completed buliding" className="w-full h-90 rounded-2xl" />
